...
1. February Dataset: Legal Status of Same-sex Marriage by US State and Year: [Link][1]

  [1]: https://github.com/zonination/samesmarriage/blob/master/ssm.csv

2. Original source of data: PewForum.org: [Link][2]

  [2]: http://www.pewforum.org/2015/06/26/same-sex-marriage-state-by-state/
