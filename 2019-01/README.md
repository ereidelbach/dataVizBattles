...
[DataIsBeautiful's](https://www.reddit.com/r/dataisbeautiful/comments/adihze/battle_dataviz_battle_for_the_month_of_january/) challenge for this month is:  <b><i>Visualize the list of the World's Oldest People.</i></b>

The data for this month's competition is sourced from the Gerontolgy Research Group [(HTML Table)](http://www.grg.org/Adams/C.HTM).
...
3. Make a top-level comment in [this thread](https://www.reddit.com/r/dataisbeautiful/comments/adihze/battle_dataviz_battle_for_the_month_of_january/) with a link directly to your visual (or your thread if you opted for Step 2). If you would like to include notes below your link, please do so. Winners will be announced in the next thread!
...
1. January 2019 Dataset: List of the World's Oldest People [(Link)][1]

  [1]: http://www.grg.org/Adams/C.HTM
